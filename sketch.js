...
function preload() {
  ...
  watersoud = loadSound("assets/cannon_water.mp3");
  piratasoud = loadSound("assets/pirate_laugh.mp3");
  cannonsoud = loadSound("assets/cannon_explosion.mp3");
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        if(!isLaughing && !piratasoud.isPlaying()){
          piratasoud.play()
          isLaughing = true;
        }
        isGameOver = true;
